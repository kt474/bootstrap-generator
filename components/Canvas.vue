<template>
  <div class="canvas-main">
    <draggable v-model="myList" class="list-group" group="people">
      ...
      >
        <div v-if="element.name === 'Accordian'">
...
export default {
  ...
  computed: {
    myList: {
      ...
      set(value) {
        this.$store.commit('updateCanvas', value)
      },
    },

    // currentComponent() {
    //   const current = this.$store.state.currentCanvas
    //   current.forEach((comp) => {
    //     if (comp.name === 'Accordian') {
    //       return 'hi'
    //     }
    //   })
    //   return null

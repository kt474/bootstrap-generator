            ...
            >
              <div class="w-full md:w-4/12 px-4">
                <div class="text-sm text-gray-600 font-semibold py-1">
                  Tailwind Generator by
                  <a
                    href="https://www.kevintian.me"
                    target="_blank"
                    class="text-gray-900 hover:text-gray-700 text-sm font-semibold py-1"
                  >
                    Kevin Tian.
                  </a>
                </div>
              ...
              <div class="w-full md:w-8/12 px-4">
                ...
                >
                  ...
                  <li>
                    <a
                      href="https://github.com/kt474/tailwind-generator/blob/main/LICENSE"
                      target="_blank"
                      class="text-gray-700 hover:text-gray-900 text-sm font-semibold block py-1 px-3"
                    >
                      MIT License
